...
# create schemas and import the data
...
# data quality checks
def checkIfEmpty(df, table_name):
    x = spark.sql("""
...
tables = ['airports_table.parquet', 'cities_table.parquet', 'i94_table.parquet', 'resident_table.parquet', 'time_table.parquet', 'visas_table.parquet']
for t in tables: 
